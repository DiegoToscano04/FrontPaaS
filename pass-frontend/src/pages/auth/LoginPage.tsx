    ...
    return (
        <div className="w-full h-screen lg:grid lg:grid-cols-2 overflow-hidden font-sans">
            ...
            <div className="hidden lg:flex relative bg-[#0B0C15] items-center justify-center overflow-hidden">
                ...
                {/* Patrón de puntos de fondo (Grid Dot Pattern) */}
                ...
                {/* Efectos de luz (Glows) para dar profundidad */}
                ...
                {/* Tarjeta Glassmorphism (Terminal) */}
                <div className="relative z-10 w-[480px] rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-md shadow-2xl">
                    ...
                    <div className="space-y-3 font-mono text-xs leading-relaxed">
                        <div className="flex gap-4">
                            ...
                            <div>
                                <span className="text-blue-400">deployment.apps/backend</span>
                                <span className="text-emerald-400 ml-2">created</span>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <span className="text-slate-600 w-4 text-right">2</span>
                            <div>
                                <span className="text-blue-400">service/db-internal</span>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                <span className="text-purple-400">ingress.networking/main</span>
                        ...
                        <div className="flex gap-4 pt-4">
                            ...
                            <span className="text-slate-300">
                                -- Building architecture... <span className="animate-pulse">Done</span>
                            </span>
                        </div>
                    </div>

                    {/* Tarjeta Flotante "Status" (Estilo Figma) */}
