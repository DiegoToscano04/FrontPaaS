...
export const RegisterPage = () => {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        // Usamos el ID del input para actualizar la propiedad correcta del objeto
        setFormData({
            ...formData,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        try {
            // 1. Registrar a través del Mock
            const newUser = await MockApi.register(formData);

            // 2. Guardar sesión en el store
            login(newUser);
    ...
    return (
        <div className="w-full h-screen lg:grid lg:grid-cols-2 overflow-hidden font-sans bg-white">
            ...
            <div className="flex flex-col justify-center p-8 md:p-12 lg:p-16 h-full relative z-10 overflow-y-auto">

                {/* Logo */}
                <div
                    className="absolute top-8 left-8 lg:left-16 flex items-center gap-2 font-bold text-slate-900 text-xl tracking-tight cursor-pointer"
                    onClick={() => navigate("/")}
                >
                ...
                <div className="mx-auto w-full max-w-[400px] space-y-6 mt-16 lg:mt-0">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {/* Contraseña Original */}
                        <div className="space-y-2">
                            <Label htmlFor="password" colonial-semibold="true">Contraseña</Label>
                            <Input
                                id="password"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="confirmPassword" colonial-semibold="true">Confirmar Contraseña</Label>
                            <Input
                                id="confirmPassword"
            ...
            {/* --- COLUMNA DERECHA (Visual) se mantiene igual --- */}
