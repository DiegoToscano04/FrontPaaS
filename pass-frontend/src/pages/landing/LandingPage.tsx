                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-2">
                            {/* Botón Azul Cuadrado */}
                            <Button size="lg" className="bg-blue-600 text-white hover:bg-blue-700 h-12 px-8 rounded-lg shadow-lg shadow-blue-200 transition-all font-semibold">
                                Empezar Laboratorio
                            </Button>

                            {/* Botón Documentación con Icono */}
                            <Button variant="outline" size="lg" className="h-12 px-8 rounded-lg border-slate-300 text-slate-700 hover:bg-slate-50 hover:border-slate-400 font-medium">
